...
public class ChannelSystemTest {
	...
	public void debug() throws Exception {
		...
		assertTrue(fvmFacadeImpl.isInitialExecutionFragment(ts,
				AlternatingSequence.of(p(seq("snd_msg(0)", "off", "wait(0)"), map()), "C!0", p(seq("set_tmr(0)", "off", "wait(0)"), map(p("C", seq(0)))), "_tmr_on!|_tmr_on?", p(seq("wait(0)", "on", "wait(0)"), map(p("C", seq(0)))), "_timeout?|_timeout!",
						p(seq("snd_msg(0)", "off", "wait(0)"), map(p("C", seq(0)))), "C!0", p(seq("set_tmr(0)", "off", "wait(0)"), map(p("C", seq(0, 0)))), "C?y", p(seq("set_tmr(0)", "off", "pr_msg(0)"), singeltonMap(p("y", 0), p("C", seq(0)))), "",
						p(seq("set_tmr(0)", "off", "snd_ack(0)"), singeltonMap(p("y", 0), p("C", seq(0)))), "D!0", p(seq("set_tmr(0)", "off", "wait(1)"), map(p("y", 0), p("C", seq(0)), p("D", seq(0)))), "C?y", p(seq("set_tmr(0)", "off", "pr_msg(1)"), map(p("y", 0), p("C", seq()), p("D", seq(0)))), "",
	...
	public void different_pg_order() throws Exception {
		...
		AlternatingSequence<Pair<List<String>, Map<String, Object>>, String> seq = AlternatingSequence.of(p(seq("snd_msg(0)", "off", "wait(0)"), map()), "C!0", p(seq("set_tmr(0)", "off", "wait(0)"), map(p("C", seq(0)))), "_tmr_on!|_tmr_on?", p(seq("wait(0)", "on", "wait(0)"), map(p("C", seq(0)))),
				"_timeout?|_timeout!", p(seq("snd_msg(0)", "off", "wait(0)"), map(p("C", seq(0)))), "C!0", p(seq("set_tmr(0)", "off", "wait(0)"), map(p("C", seq(0, 0)))), "C?y", p(seq("set_tmr(0)", "off", "pr_msg(0)"), singeltonMap(p("C", seq(0)), p("y", 0))), "",
				p(seq("set_tmr(0)", "off", "snd_ack(0)"), singeltonMap(p("C", seq(0)), p("y", 0))), "D!0", p(seq("set_tmr(0)", "off", "wait(1)"), map(p("C", seq(0)), p("D", seq(0)), p("y", 0))), "C?y", p(seq("set_tmr(0)", "off", "pr_msg(1)"), map(p("C", seq()), p("D", seq(0)), p("y", 0))), "",
	...
	public void test10() throws Exception {
		...
		assertEquals(set(p(seq("l1", "l2"), singeltonMap(p("y", 1), p("C", seq(1)))), p(seq("l1", "l1"), singeltonMap(p("y", 0), p("C", seq()))), p(seq("l1", "l1"), singeltonMap(p("y", 1), p("C", seq()))), p(seq("l1", "l2"), map(p("x", 1), p("y", 1), p("C", seq(1)))), p(seq("l2", "l2"), map(p("x", 0), p("y", 0), p("C", seq()))),
						p(seq("l2", "l2"), map(p("x", 1), p("y", 1), p("C", seq()))), p(seq("l1", "l1"), map(p("x", 1), p("y", 1), p("C", seq()))), p(seq("l1", "l1"), map(p("y", 0))), p(seq("l1", "l1"), map(p("y", 1))), p(seq("l1", "l2"), singeltonMap(p("y", 0), p("C", seq(0))))),
				ts.getStates());
		...
		assertEquals(set(transition(p(seq("l1", "l2"), singeltonMap(p("y", 0), p("C", seq(0)))), "C?y", p(seq("l1", "l1"), singeltonMap(p("y", 0), p("C", seq())))), transition(p(seq("l1", "l2"), singeltonMap(p("y", 1), p("C", seq(1)))), "C?x", p(seq("l2", "l2"), map(p("x", 1), p("y", 1), p("C", seq())))),
				transition(p(seq("l1", "l1"), map(p("y", 0))), "C!y", p(seq("l1", "l2"), singeltonMap(p("y", 0), p("C", seq(0))))), transition(p(seq("l1", "l1"), singeltonMap(p("y", 0), p("C", seq()))), "C!y", p(seq("l1", "l2"), singeltonMap(p("y", 0), p("C", seq(0))))),
				transition(p(seq("l1", "l2"), singeltonMap(p("y", 0), p("C", seq(0)))), "C?x", p(seq("l2", "l2"), map(p("x", 0), p("y", 0), p("C", seq())))), transition(p(seq("l1", "l2"), map(p("x", 1), p("y", 1), p("C", seq(1)))), "C?x", p(seq("l2", "l2"), map(p("x", 1), p("y", 1), p("C", seq())))),
				transition(p(seq("l1", "l2"), singeltonMap(p("y", 1), p("C", seq(1)))), "C?y", p(seq("l1", "l1"), singeltonMap(p("y", 1), p("C", seq())))), transition(p(seq("l1", "l2"), map(p("x", 1), p("y", 1), p("C", seq(1)))), "C?y", p(seq("l1", "l1"), map(p("x", 1), p("y", 1), p("C", seq())))),
				transition(p(seq("l1", "l1"), map(p("y", 1))), "C!y", p(seq("l1", "l2"), singeltonMap(p("y", 1), p("C", seq(1))))), transition(p(seq("l1", "l1"), singeltonMap(p("y", 1), p("C", seq()))), "C!y", p(seq("l1", "l2"), singeltonMap(p("y", 1), p("C", seq(1))))),
		...
		assertEquals(set("y = 1", "C = [1]", "l1", "l2"), ts.getLabel(p(seq("l1", "l2"), singeltonMap(p("y", 1), p("C", seq(1))))));
		assertEquals(set("C = []", "y = 0", "l1"), ts.getLabel(p(seq("l1", "l1"), singeltonMap(p("y", 0), p("C", seq())))));
		assertEquals(set("C = []", "y = 1", "l1"), ts.getLabel(p(seq("l1", "l1"), singeltonMap(p("y", 1), p("C", seq())))));
		...
		assertEquals(set("C = [0]", "y = 0", "l1", "l2"), ts.getLabel(p(seq("l1", "l2"), singeltonMap(p("y", 0), p("C", seq(0))))));
