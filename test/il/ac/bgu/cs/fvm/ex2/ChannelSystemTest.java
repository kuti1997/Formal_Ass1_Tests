...
public class ChannelSystemTest {
	...
	public void test10() throws Exception {
		...
		assertEquals(set(p(seq("l1", "l2"), singeltonMap(p("y", 1), p("C", seq(1)))), p(seq("l1", "l1"), singeltonMap(p("y", 0), p("C", seq()))), p(seq("l1", "l1"), singeltonMap(p("y", 1), p("C", seq()))), p(seq("l1", "l2"), map(p("x", 1), p("y", 1), p("C", seq(1)))),
				p(seq("l2", "l2"), map(p("x", 0), p("y", 0), p("C", seq()))), p(seq("l2", "l2"), map(p("x", 1), p("y", 1), p("C", seq()))), p(seq("l1", "l1"), map(p("x", 1), p("y", 1), p("C", seq()))), p(seq("l1", "l1"), map(p("y", 0))), p(seq("l1", "l1"), map(p("y", 1))),
				p(seq("l1", "l2"), singeltonMap(p("y", 0), p("C", seq(0))))), ts.getStates());
		...
		assertEquals(set(transition(p(seq("l1", "l2"), singeltonMap(p("y", 0), p("C", seq(0)))), "C?y", p(seq("l1", "l1"), singeltonMap(p("y", 0), p("C", seq())))),
				transition(p(seq("l1", "l2"), singeltonMap(p("y", 1), p("C", seq(1)))), "C?x", p(seq("l2", "l2"), map(p("x", 1), p("y", 1), p("C", seq())))), transition(p(seq("l1", "l1"), map(p("y", 0))), "C!y", p(seq("l1", "l2"), singeltonMap(p("y", 0), p("C", seq(0))))),
				transition(p(seq("l1", "l1"), singeltonMap(p("y", 0), p("C", seq()))), "C!y", p(seq("l1", "l2"), singeltonMap(p("y", 0), p("C", seq(0))))), transition(p(seq("l1", "l2"), singeltonMap(p("y", 0), p("C", seq(0)))), "C?x", p(seq("l2", "l2"), map(p("x", 0), p("y", 0), p("C", seq())))),
				transition(p(seq("l1", "l2"), map(p("x", 1), p("y", 1), p("C", seq(1)))), "C?x", p(seq("l2", "l2"), map(p("x", 1), p("y", 1), p("C", seq())))), transition(p(seq("l1", "l2"), singeltonMap(p("y", 1), p("C", seq(1)))), "C?y", p(seq("l1", "l1"), singeltonMap(p("y", 1), p("C", seq())))),
				transition(p(seq("l1", "l2"), map(p("x", 1), p("y", 1), p("C", seq(1)))), "C?y", p(seq("l1", "l1"), map(p("x", 1), p("y", 1), p("C", seq())))), transition(p(seq("l1", "l1"), map(p("y", 1))), "C!y", p(seq("l1", "l2"), singeltonMap(p("y", 1), p("C", seq(1))))),
				transition(p(seq("l1", "l1"), singeltonMap(p("y", 1), p("C", seq()))), "C!y", p(seq("l1", "l2"), singeltonMap(p("y", 1), p("C", seq(1))))), transition(p(seq("l1", "l1"), map(p("x", 1), p("y", 1), p("C", seq()))), "C!y", p(seq("l1", "l2"), map(p("x", 1), p("y", 1), p("C", seq(1))))),
